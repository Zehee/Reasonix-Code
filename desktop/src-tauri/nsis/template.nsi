...
; Hide the "Run app" checkbox when this installer just installed Node.js
; (see Var InstalledNodeByUs): the user must start the app from the
; shortcut so a fresh process picks up the new PATH.
Function MyFinishShow
  ${If} $InstalledNodeByUs = 1
