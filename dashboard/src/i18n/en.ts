export const en = {
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside reasonix-code code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside reasonix-code code to attach.",
  ...
  permissions: {
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active reasonix-code code session — standalone reasonix-code dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    saved: "saved",
    savedRestart: "saved — restart reasonix-code code to bridge this server",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when reasonix-code code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart reasonix-code code, then refresh this dashboard.",
    bridgeFailed: "Bridge failed",
    bridgeFailedTitle: "bridge failed · in config",
    bridgeFailedHint:
      "Reasonix tried to bridge this server and the attempt errored. Common causes: wrong URL, missing auth header, upstream 404/5xx, missing local command. Fix and restart reasonix-code code to retry.",
    ...
    marketplaceEnvHint:
      "Set these in your shell before next `reasonix-code code` so the bridged server can authenticate.",
    marketplaceRestartHint:
      "Spec written to ~/.reasonix/config.json. Restart `reasonix-code code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from reasonix-code code to edit project hooks.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run reasonix-code index to build",
    usageLog: "usage log",
